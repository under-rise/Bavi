		...
		<section id="venue" class="cont">
			...
			<section>
				<div class="double_slick">
                    <div class="colona_icon"><img src="resources/images/icon_colona_open.png?1.1" alt="コロナ対策認証店 営業中"/></div>
            ...
            <div class="colona_sec">
                ...
                <dl>
                <dt>コロナ禍対応<br>1組人数制限</dt>
                <dd>000人</dd>
                </dl>
                
                <dl>
                <dt>コロナ禍会場<br>最大ご利用人数</dt>
                <dd>000人</dd>
                </dl>
