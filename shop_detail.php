...
<head>
    ...
    <title>養老乃瀧 | 日本最大級のBBQプラットフォーム Bavi</title>
...
<body id="shop_page">
    ...
    <div id="wrapper">
        ...
        <?php include __DIR__ . '/tpl/header_shop.php'; ?>
        ...
        <article class="detail">
            ...
            <section id="venue" class="cont">
                <h2 class="tit"><span class="kinki">近畿</span>養老乃瀧</h2>

                <section>
                    <div class="double_slick">
                        <div class="colona_icon"><img src="/assets/img/icon_colona.png" alt="コロナ対策推奨店" /></div>
                        <div class="main_slick">
                            <div class="modal" data-name=".gallery_sec"><img src="/resources/images/top/test/shop1.jpg" alt="" /></div>
                            <div class="modal" data-name=".gallery_sec"><img src="/resources/images/top/test/shop2.jpg" alt="" /></div>
                            <div class="modal" data-name=".gallery_sec"><img src="/resources/images/top/test/shop3.jpg" alt="" /></div>
                        </div>

                        <ul class="slick_nav">
                            <li><img src="/resources/images/top/test/shop1.jpg" alt="" /></li>
                            <li><img src="/resources/images/top/test/shop2.jpg" alt="" /></li>
                            <li><img src="/resources/images/top/test/shop3.jpg" alt="" /></li>
                        </ul>
                    </div>
        ...
        -->
            ...
            <a href="/shop_list.php" class="back_btn"><img src="/assets/img/back_btn.png" alt="一覧に戻る" /></a>
