			...
			<section>
				<div class="double_slick">
					...
					<div class="main_slick">
						...
						<div class="modal" data-name=".gallery_sec"><img src="resources/images//shop/shop_slider01.jpg" /></div>
						<div class="modal" data-name=".gallery_sec"><img src="resources/images//shop/shop_slider02.jpg" /></div>
                        <div class="modal" data-name=".gallery_sec"><img src="resources/images//shop/shop_slider03.jpg" /></div>
					</div>
		...
		<section id="order" class="cont">
			...
			<section>
				...
				<table>
					...
					<tr>
						<th>URL</th>
						<td><a href="https://meet-sshop.com/order/" target="_blank">https://meet-sshop.com/order/</a></td>
					</tr>
				</table>
			</section>
