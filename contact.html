...
<head>
	...
	<link rel="stylesheet" href="resources/css/contact_sp.css">
...
<div id="wrapper">
	...
	<article class="no_fixed">
		...
		<section class="cont">
			...
			<p>「Bavi」にアクセスいただき、誠にありがとうございます。<br />サービスについての質問・ご相談を承っています。</p>
			
			<form>
				<dl>
					<dt class="hissu">お問合わせの種類</dt>
					<dd>
						<ul>
							<li><label><input type="radio" name="お問合わせの種類"><span>サービスについて</span></label></li>
							<li><label><input type="radio" name="お問合わせの種類"><span>会場・店舗掲載について</span></label></li>
							<li><label><input type="radio" name="お問合わせの種類"><span>広告掲載について</span></label></li>
							<li><label><input type="radio" name="お問合わせの種類"><span>メディア・プレス関係</span></label></li>
							<li><label><input type="radio" name="お問合わせの種類"><span>その他</span></label></li>
						</ul>
					</dd>
					...
					<dt class="hissu">お問合わせ内容</dt>
					<dd><textarea></textarea></dd>
				</dl>
				
				<button type="submit" class="confirm_btn">確認する</button>
	...
	<footer>
		...
		<nav>
			<ul>
				<li><a href="/about.html">Baviについて</a></li>
	...
	<nav id="overlay_nav" >
		...
		<div>
			...
			<dl>
				...
				<dt>その他</dt>
				<dd><a href="/about.html">Baviについて</a></dd>
