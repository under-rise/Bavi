...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/admin/css/analysis.css?1.331">
                    ...
                    <div id="admin" class="analysis_sec top flex justify-between">
                        ...
                        <div class="analysis_detail itemBOX shadow">
                            ...
                            <ul class="time_select">
                                <li class="week active" data-time-select="week">週別</li>
                                <li class="month" data-time-select="month">月別</li>
                            </ul>
