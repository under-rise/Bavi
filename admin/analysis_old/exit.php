...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/admin/css/analysis.css?1.33">
                            ...
                            <div class="inr">
                                ...
                                <table class="table_style">
                                    <tr>
                                        <th>ページ名</th>
                                        <th>url</th>
                                        <th class="sort" data-num="reverse">離脱回数 ▼</th>
                                    </tr>
                                    <tr>
                                        <td>コラム【アドバイス】 | 日本最大級のBBQプラットフォーム Bavi</td>
                                        <td><a href="#">https://bavi.jp/spot?pref_id=13</a></td>
                                        <td>821回</td>
                                    </tr>

                                    <tr>
                                        <td>BBQ場【青森県】 | 日本最大級のBBQプラットフォーム Bavi</td>
                                        <td><a href="#">https://bavi.jp/spot?pref_id=13</a></td>
                                        <td>1330人</td>
                                    </tr>

                                    <tr>
                                        <td>BBQ場【東京】 | 日本最大級のBBQプラットフォーム Bavi</td>
                                        <td><a href="#">https://bavi.jp/spot?pref_id=13</a></td>
                                        <td>230人</td>
                                    </tr>
