                        ...
                        <div class="analysis_detail itemBOX shadow">
                            ...
                            <div class="inr">
                                ...
                                <ul class="time_select_link">
                                    <li class="week"><a href="#">前の月</a></li>
                                    <li class="month active">2022年10月</li>
                                    <li class="month"><a href="#">次の月</a></li>
                                </ul>
