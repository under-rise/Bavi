...
$(function () {
  ...
  function setState(year, month, count) {
    ...
    switch (jsonData[d].state) {
      case 0:
        return `<a>${state_html[0]}</a>`;
      case 1:
        return `<a href="http://bavi.jp/spot/detail/${SHOP_ID}/order/?date=${query}" data-date="${query}" target="_blank">${state_html[1]}</a>`;
      case 2:
        return `<a href="http://bavi.jp/spot/detail/${SHOP_ID}/order/?date=${query}" data-date="${query}" target="_blank">${state_html[2]}</a>`;
      case 3:
  ...
  <dl>
      <dt><img src="images/calendar/icon01.png"></dt>
      <dd>受付対象外</dd>
  </dl>
  <dl>
      <dt><img src="images/calendar/icon02.png"></dt>
      <dd>空きあり</dd>
  </dl>
  <dl>
      <dt><img src="images/calendar/icon03.png"></dt>
      <dd>残りわずか</dd>
  </dl>
  <dl>
      <dt><img src="images/calendar/icon04.png"></dt>
      <dd>満員</dd>
  </dl>
</div>`;
});
