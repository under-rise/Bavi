...
<div id="wrapper">
	...
	<article class="detail">
		...
		<section id="venue" class="cont">
			...
			<h2 class="tit"><span class="kanto">東 京</span>Baviバーベキュー広場</h2>
			...
			<section>
				<div class="double_slick">
					...
					<div class="main_slick">
						<div><img src="sample/slider01.jpg"  alt=""/></div>
						<div><img src="sample/slider01.jpg"  alt=""/></div>
                        <div><img src="sample/slider03.jpg" alt=""/></div>
					</div>
            ...
            <div class="colona_sec">
                ...
                <dl>
                <dt>お約束事項</dt>
                <dd>館内（客室内を除く）では必ずマスクを着用してください。 </dd>
                </dl>
                
                <dl>
                <dt>会場からのコメント</dt>
                <dd>・館内（客室内を除く）では必ずマスクを着用してください。<br>・フロント前やエレベータ前等では、他のお客様と適度な距離（ソーシャル・ディスタンス）
を維持してください。<br>
・エレベーターは原則1台に1組の乗車とし、混雑の場合には次の到着をお待ちください。<br>
・ロビーや廊下において大声での会話はお控えください。<br>
・御自身もしくはご家族に2週間以内の海外渡航歴がある場合、感染者との濃厚接触がある場合、及び発熱や呼吸器異常等の感染症状がある場合には、必ずフロントにお知らせください。<br>
・レジストレーションカードには必ず正確な電話番号等連絡先をご記入ください。</dd>
                </dl>
				</div>
			...
			<section class="news_sec">
                ...
                <li>
                    <div class="img">
                 <img src="sample/news01.jpg" width="450" height="290" alt=""/>
                    </div>
                    <div class="txt">
                    <p class="day">2021.7.24(MON)</p>
				   <h4>ラグジュアリーコース ¥4,000円（1名様）</h4>
				   <p>和牛専門店プロデュース！選べる3プランでラグジュアリーコース ¥4,000円（1名様）にてご提供！</p>
                    </div>
                </li>
                    
                <li>
                    <div class="img">
                        <img src="sample/news02.jpg" width="450" height="290" alt=""/>
                     </div>
                    <div class="txt">
                    <p class="day">2021.2.24(MON)</p>
				   <h4>キッズコース ¥1,000円（未就学児 専用アイテム）</h4>
				   <p>テBBQメンバーにお子様持ちの方が多い幹事様、必見です！6歳未満の未就学児は1名1,000円でバーベキューがご利用いただけます。 お子様用のチェア、お食事メニュー、かわいいお皿やコップ、またおもちゃまでご用意し、大人様同様におもてなし致します。</p>
                    </div>
                </li>
...
秋田自動車道 能代南ICから約40km<br><br>
		...
		<section id="shop" class="cont">
			...
			<section>
				<img src="sample/sell.jpeg" alt=""/>
                
<h3>バーベキューに必要な食材・機材すべてレンタル・販売します!</h3>
				
				<p>ＢＢＱ専門店だからできる価格です。エリアが近い方、トラック等が手配できる方には大変お得なポイントです！</p>
			</section>
			
			<table>
				<tr>
					<th>ファミリー焼肉セット【４〜5人前】</th>
					<td>自家製タレ付き</td>
					<td>￥5,980<span class="small">（税別）</span></td>
				</tr>
				<tr>
					<th>バーベキュー道具一式（5人前）</th>
					<td>バーベキューに必要な道具一式をレンタル販売。</td>
					<td>￥6,500<span class="small">（税別）</span></td>
				</tr>
				<tr>
					<th>バーベキューテント</th>
					<td>2名様〜5名様用のテント貸出中。</td>
					<td><span>要確認</span></td>
				</tr>
			</table>
		...
		<section id="campaign" class="cont">
            ...
            <div class="inr">
                ...
                <ul class="slick_campaign">
                    ...
                    <li>
                    <div class="img"><img src="resources/images/coupon.jpg" width="800" height="600" alt=""/></div>
                    <p class="day">2021.01.31(MON)</p>
                    <h3>8月のキャンペーン実施中！</h3>
                    <p>本格BBQコース3,000円（1名様）を毎日先着10名様にご提供！</p>
                    <a class="modal link_btn" data-name=".campaign_modal_id_000">クーポンを見る</a>
                    </li>
        ...
        <div class="campaign_modal_id_000 campaign_modal modal_sec" style="display: none;">
                 ...
                 <div class="inr">
                    ...
                    <span class="close">+</span>
                     <div class="img">
                         <img src="resources/images/coupon.jpg" width="800" height="600" alt=""/>
                     </div>
		...
		<section id="access" class="cont">
			...
			<p>東京都足立区大谷田3-21-6<br />TEL: TEL.03-5849-3221</p>
                            ...
                            <tr>
                                <th>電車</th>
                                <td>北綾瀬駅より徒歩15分<br>綾瀬駅より徒歩5分</td>
                            </tr>
		...
		<section id="spot" class="cont">
			...
			<div class="slick">
				<div class="item">
					<a href="">
						<img src="sample/spot01.jpg"  alt=""/>
                        
<h3><span>2021.6.14(MON)</span>IN THE GREEN BEER GARDEN & BBQ</h3>
						
						<p>ルミネ池袋屋上のルーフトップで開放的なガーデンBBQ！<span>続きを見る＞</span></p>
					</a>
				</div>
				<div class="item">
					<a href="">
						<img src="sample/spot02.jpg"  alt=""/>
<h3><span>2021.5.14(SUN)</span>白金imakara</h3>
						
						<p>都内の中心部にありながら、喧騒を忘れることのできるレストラン。<span>続きを見る＞</span></p>
					</a>
				</div>
				<div class="item">
					<a href="">
		...
		<section id="voice" class="cont">
			...
			<section>
				...
				<p>接客が素晴らしかったです。出迎えてくださったスタッフの方がとてもにこやかで親切にしてくださり、最初からとても印象が良かったです。それからご飯がとても美味しかったです。</p>
			</section>
			...
			<section>
				...
				<p>感染症対策をしっかりと行い準備してくれたので安心でした。全体的に居心地の良い素敵な宿でした。また行きたいです。</p>
				
				<section>
					<h4>Baviバーベキュー広場からの返信</h4>
					
					<p>この度はBaviバーベキュー広場をご利用いただきまして、誠にありがとうございました。「接客が素晴らしい」その一言が、とても嬉しく励みになります。感染対策も出来る限りの対応となっておりますが、安心してお過ごしいただけましたようで幸いです。</p>
				</section>
			</section>
